        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    &nbsp;
                    <asp:Button ID="Button2" runat="server" align="center"  CausesValidation="False" OnClick="Button2_Click" style="height: 50px" Text="Back" ToolTip="Back to Home Page" Font-Size="Medium" Width="100px" CssClass="button" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
