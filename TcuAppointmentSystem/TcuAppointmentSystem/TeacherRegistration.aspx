<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherRegistration.aspx.cs" Inherits="TcuAppointmentSystem.TeacherRegistration" %>
        ...
        <table>
            <tr>
                ...
                <td class="auto-style9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="Teacherid" runat="server" placeholder="Instructor ID" Width="280px"></asp:TextBox>
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                <td class="auto-style11">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="Teacherid" ErrorMessage="*Teacher id is Required" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" class="auto-style6">Department:</td>
                <td style="height: 33px; width: 295px;">
                    <asp:TextBox ID="Department" runat="server" Enabled="false" placeholder ="Course" Width="274px"></asp:TextBox>
                </td>
                <td class="auto-style3">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="Department" ErrorMessage="*Department is Required" ForeColor="Red"></asp:RequiredFieldValidator>
                    </td>
            </tr>
            <tr>
                <td align="right" class="auto-style6">Email</td>
                <td class="auto-style12">
                    <asp:TextBox ID="Email" runat="server"  Enabled="false" placeholder="Email" Width="280px"></asp:TextBox>
                </td>
                <td class="auto-style3">
