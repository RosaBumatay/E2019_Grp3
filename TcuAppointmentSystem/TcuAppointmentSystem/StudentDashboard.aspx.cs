    ...
    public partial class StudentDashboard : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            while (rd.Read())
            {
                ...
                Instructor.Text = rd.GetValue(1).ToString();
                Dept.Text = rd.GetValue(4).ToString();
                InstructorEmail.Text = rd.GetValue(5).ToString();
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('Invalid Instructor Email Address');", true);
                        }
                        else
                        {
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('There is no appointment between the chosen student and Instructor ');", true);
            }
