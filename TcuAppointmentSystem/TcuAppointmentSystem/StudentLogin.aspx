        ...
        <table class="auto-style2">
            <tr>
                ...
                <td class="auto-style7">
                    <asp:TextBox ID="TextBox_User" runat="server" placeholder="Student ID" Width="200px"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button" runat="server" align="center" BorderColor="#99CCFF" BorderStyle="Dotted" Font-Names="Calibri Light" Font-Overline="False" Font-Size="Small" Font-Underline="True" ForeColor="#6699FF" OnClick="Button1_Click" style="height: 36px" Text="Login" ToolTip="Login to User Page" Width="80px" />
                    &nbsp;
